                ...
                <div className={style.item__flex}>
                    ...
                    <div className={style.slider}>
                        <div className={style.slider__container}>
                            <div className={style.slider__left__side}>
                                ...
                                <div className={style.left__slider__item} onClick={setFirstMain}><img src={acne}
                                                                                                      alt=""/></div>
                                <div className={style.left__slider__item} onClick={setSecondMain}><img src={second}
                                                                                                       alt=""/></div>
                                <div className={style.left__slider__item} onClick={setThirdMain}><img src={third}
                                                                                                      alt=""/></div>
                                <div className={style.left__slider__item__before}><img src={before} alt=""/></div>

                            </div>
                            <div className={defaultImage.defaultImage}><img src={acne} alt="" className={defaultImage}/>
                            </div>
                    ...
                    <div className={style.slider__description}>
                        <div className={style.item__2__Container}>
                            ...
                            <div className={style.description__title__acne}>Acne Treatment Cystic Acne heals, repairs &
                                renews
                            </div>
                            <div>
                                <div className={style.description__title__text}> Description:</div>
                                <div className={style.description__text}>Addictively refreshing gel-cream leaves skin
                                    plump, dewy, glowing.
                                </div>
                            </div>
                            ...
                            <div className={style.amazonPrime__flex}>
                                ...
                                <div className={style.amazonPrime}><a href="https://www.amazon.com/amazonprime"><img
                                    src={amazonPrime} alt=""/></a></div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className={style.what__it__does__item__last}>
                            ...
                            <div className={style.overview__text}> Helps strengthen skin’s own moisture
                                barrier so more moisture stays in. Skin that holds onto moisture has a youthful-looking
                                glow.
                            </div>
                        </div>

                    </div>
                    <span className={readMoreStyle.readMoreStyle}> <div className={style.show_readMore}
                                                                        onClick={onToggleClick}> Read more... </div> </span>
                    <div className={showInfoStyle}>
                        <div className={style.margin}>
                            <div className={style.overview__header}> Key Ingredients</div>
                            <div className={style.overview__text__what}>Sunflower Seed Cake, Barley Extract and Cucumber
                                Fruit Extract help strengthen skin’s barrier,
                                improve its resiliency,
                                and balance and retain skin’s moisture levels. Hyaluronic acid acts as a natural
                                moisture magnet/humectant.
                            </div>

                            <div className={style.hide__button__container}>
                                <div className={style.price}>
                                    <div className={style.first_price}>us$25.89</div>
                                    <div className={style.second__price}>$0.00 FREE</div>
